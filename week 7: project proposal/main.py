#For our project we plan on creating a chess game that involves a tournamnet betweenplayers.

#Chess is a two-player strategy board game played on a checkered board with 64 squares arranged in an 8*8 square grid.

#Play involves no hidden information. Each player begins with 16 pieces:
...
#we plan on starting with our game class that controls the flow our game. It keeps track of all game move, which
#player has the current turn, and the final results of the game.
#we plan creating different classes too to help us in creating functionality and variables of all steps required in making the game.